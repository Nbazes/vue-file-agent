...
var upload_helper_UploadHelper = /** @class */ (function () {
    ...
    UploadHelper.prototype.doTusUpload = function (tus, url, fileRecord, headers, progressCallback, tusOptionsFn, skipCreate) {
        if (skipCreate === void 0) { skipCreate = false; }
    ...
    UploadHelper.prototype.tusUpload = function (tus, url, headers, fileRecords, progressFn, tusOptionsFn, skipCreate) {
        var e_3, _a;
        var _this = this;
        var updateOverallProgress = function () {
            /* no op */
...
/* harmony default export */ var vue_file_agent_mixin = (external_commonjs_vue_commonjs2_vue_root_Vue_default.a.extend({
    ...
    methods: {
        ...
        tusOptionsFn: function () {
            var tusOption = {};
            if (this.retryDelays) {
                tusOption.retryDelays = this.retryDelays;
            }
            if (this.chunkSize) {
                tusOption.chunkSize = this.chunkSize;
            }
            if (this.retryDelays) {
                tusOption.parallelUploads = this.parallelUploads;
            }
            return tusOption;
        },
        upload: function (url, headers, fileRecordsOrRaw, createFormData, configureXhr) {
            ...
            if (this.resumable) {
                var retryDelays = this.retryDelays;
                var chunkSize = this.chunkSize;
                var parallelUploads = this.parallelUploads;
                ...
                this.tusOptionsFn, this.skipCreate ? this.skipCreate : false);
            }
            return new Promise(function (resolve, reject) {
                upload_helper
